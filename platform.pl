...
if ($os =~ /IRIX64/i) {
  ...
  print OUTFILE "METISROOT =\n";
  print OUTFILE "ifneq (\$(METISROOT),)\n";
  print OUTFILE "  LIBS_SER = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  LIBS_OMP = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  LIBS_MPI = -lmpi -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  PART_OBJS = SwanParallel.o\n";
  print OUTFILE "else\n";
  print OUTFILE "  LIBS_SER =\n";
  print OUTFILE "  LIBS_OMP =\n";
  print OUTFILE "  LIBS_MPI = -lmpi\n";
  print OUTFILE "  PART_OBJS =\n";
  print OUTFILE "endif\n";
  ...
  print OUTFILE "  LIBS_SER = \$(LIBS_SER) -L\$(NETCDFROOT)/lib -lnetcdf -lnetcdff\n";
  print OUTFILE "  LIBS_OMP = \$(LIBS_OMP) -L\$(NETCDFROOT)/lib -lnetcdf -lnetcdff\n";
  print OUTFILE "  LIBS_MPI = \$(LIBS_MPI) -L\$(NETCDFROOT)/lib -lnetcdf -lnetcdff\n";
  ...
  print OUTFILE "ifneq (\$(METISROOT),)\n";
  print OUTFILE "  swch = -unix -f95 -timg -sgi -metis\n";
  print OUTFILE "else\n";
  print OUTFILE "  swch = -unix -f95 -timg -sgi\n";
  print OUTFILE "endif\n";
  print OUTFILE "ifneq (\$(NETCDFROOT),)\n";
  print OUTFILE "  swch = \$(swch) -netcdf\n";
  print OUTFILE "endif\n";
}
elsif ($os =~ /AIX/i) {
  print OUTFILE "##############################################################################\n";
  ...
  print OUTFILE "METISROOT =\n";
  print OUTFILE "ifneq (\$(METISROOT),)\n";
  print OUTFILE "  LIBS_SER = -L\$(METISROOT)/lib -lmetis -lGKlib -lessl -lmass\n";
  print OUTFILE "  LIBS_OMP = -L\$(METISROOT)/lib -lmetis -lGKlib -lessl -lmass\n";
  print OUTFILE "  LIBS_MPI = -L\$(METISROOT)/lib -lmetis -lGKlib -lessl -lmass\n";
  print OUTFILE "  PART_OBJS = SwanParallel.o\n";
  print OUTFILE "else\n";
  ...
  print OUTFILE "RM = rm -f\n";
  print OUTFILE "ifneq (\$(METISROOT),)\n";
  print OUTFILE "  swch = -unix -f95 -timg -metis\n";
  print OUTFILE "else\n";
  ...
  print OUTFILE "RM = rm -f\n";
  print OUTFILE "ifneq (\$(METISROOT),)\n";
  print OUTFILE "  swch = -unix -timg -metis\n";
  print OUTFILE "else\n";
  print OUTFILE "  swch = -unix -timg\n";
  print OUTFILE "endif\n";
  print OUTFILE "ifneq (\$(NETCDFROOT),)\n";
  ...
  print OUTFILE "  LIBS_SER = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  LIBS_OMP = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  LIBS_MPI = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
  print OUTFILE "  PART_OBJS = SwanParallel.o\n";
  print OUTFILE "else\n";
  print OUTFILE "  LIBS_SER =\n";
  print OUTFILE "  LIBS_OMP =\n";
...
#    print OUTFILE "FLAGS_MSC = -W0 -assume byterecl -traceback -diag-disable remark\n";
    ...
    print OUTFILE "RM = rm -f\n";
    print OUTFILE "ifneq (\$(METISROOT),)\n";
    print OUTFILE "  swch = -unix -impi -metis\n";
    print OUTFILE "else\n";
  ...
  elsif ( $compiler eq "gfortran" )
  {
    ...
    if ($ver >= 10) {
      print OUTFILE "# from version 10 and higher, gfortran does not accept argument mismatches; see https://gcc.gnu.org/gcc-10/porting_to.html\n";
    ...
    print OUTFILE "ifneq (\$(METISROOT),)\n";
    print OUTFILE "  LIBS_SER = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
    print OUTFILE "  LIBS_OMP = -L\$(METISROOT)/lib -lmetis -lGKlib -static-libgcc\n";
    print OUTFILE "  LIBS_MPI = -L\$(METISROOT)/lib -lmetis -lGKlib\n";
    print OUTFILE "  PART_OBJS = SwanParallel.o\n";
    print OUTFILE "else\n";
    print OUTFILE "  LIBS_SER =\n";
  ...
  elsif ( $compiler eq "xlf90" )
  {
    ...
    print OUTFILE "RM = rm -f\n";
    print OUTFILE "ifneq (\$(METISROOT),)\n";
    print OUTFILE "  swch = -unix -matl4 -metis\n";
    print OUTFILE "else\n";
...
#    print OUTFILE "!ENDIF\n";
  ...
  elsif ( $compiler eq "f90" )
  {
    ...
    print OUTFILE "FLAGS_MPI =\n";
    print OUTFILE "METISROOT:\n";
    print OUTFILE "!IF DEFINED(METISROOT)\n";
    print OUTFILE "PART_OBJS = SwanParallel.obj\n";
    print OUTFILE "!ELSE\n";
    print OUTFILE "PART_OBJS =\n";
    print OUTFILE "!ENDIF\n";
    print OUTFILE "NETCDFROOT:\n";
    ...
    print OUTFILE "RM = del\n";
    print OUTFILE "!IF DEFINED(METISROOT)\n";
    print OUTFILE "swch = -dos -impi -cvis -metis\n";
    print OUTFILE "!ELSE\n";
    print OUTFILE "swch = -dos -impi -cvis\n";
    print OUTFILE "!ENDIF\n";
    print OUTFILE "!IF DEFINED(NETCDFROOT)\n";
