...
!TIMG       call SWTSTO(105)
       ...
       if ( ITEST >= 30 .or. idebug == 1 ) then
          ...
          !
          call SWREDUCE( npfr , 1, SWINT, SWSUM )
          call SWREDUCE( mxnfr, 1, SWINT, SWMAX )
          !
       ...
       if ( ITEST >= 30 .or. idebug == 1 ) then
          ...
          ! perform global reductions in parallel run
          !
          call SWREDUCE( npfl , 1, SWINT, SWSUM )
          call SWREDUCE( mxnfl, 1, SWINT, SWMAX )
          !
          ...
          mnisl = minval(islmin)
          !
          call SWREDUCE( mnisl, 1, SWINT, SWMIN )
          !
       ...
       !
       if ( ITEST >= 30 .or. idebug == 1 ) then
          call SWREDUCE( inocnv , 1, SWINT, SWSUM )
